...
protocol CTSignUpFromViewDelegate: class {
    func didRequestAuth()
}

class CTSignUpFormView: UIView {
    
    @IBOutlet var contentView: UIView!
    
    weak var delegate: CTSignUpFromViewDelegate?
    ...
    private func commonInit() {
        // init stuff here...
        Bundle.main.loadNibNamed("CTSignUpFormView", owner: self, options: nil)
    ...
    @IBAction func switchModePressed(_ sender: Any) {
        ...
        if isSignUpMode {
            ...
            confirmButton.setTitle("Login In", for: .normal)
        }
    }
